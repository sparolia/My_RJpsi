...
void Macro_compare_gen(){
  ...
  TFile *f1 = TFile::Open("bc_jpsi_tau_nu_gen_v2.root"); //opening the signal root file of old data
  TTree *tree_sig = (TTree*)f1->Get("tree"); //reading the tree from the ntuple
  ...
  TFile *f3 = TFile::Open("bc_jpsi_tau_nu_gen_2018.root"); //opening the signal root file of 2018 data
  TTree *tree_sig_18 = (TTree*)f3->Get("tree"); //reading the tree from the ntuple
  ...
  tree_sig->SetBranchAddress("trigDimuon0",&Trig_dimuon_sig);
  tree_sig->SetBranchAddress("trigJpsiTk",&Trig_JpsiTk_sig);

  tree_sig->SetBranchAddress("taunu_pt",&taunu_pt_sig); 
  tree_sig->SetBranchAddress("taunu_eta",&taunu_eta_sig); 
  tree_sig->SetBranchAddress("taunu_phi",&taunu_phi_sig);

  tree_sig->SetBranchAddress("taunu2_pt",&taunu2_pt_sig); 
  tree_sig->SetBranchAddress("taunu2_eta",&taunu2_eta_sig); 
  tree_sig->SetBranchAddress("taunu2_phi",&taunu2_phi_sig);

  tree_sig->SetBranchAddress("munu_pt",&munu_pt_sig); 
  tree_sig->SetBranchAddress("munu_eta",&munu_eta_sig); 
  tree_sig->SetBranchAddress("munu_phi",&munu_phi_sig);
  ...
  tree_sig_18->SetBranchAddress("mu_pt",&mu_pt_sig_18); 
  tree_sig_18->SetBranchAddress("mu_eta",&mu_eta_sig_18); 
  tree_sig_18->SetBranchAddress("mu_phi",&mu_phi_sig_18);

  tree_sig_18->SetBranchAddress("mu1_pt",&mu1_pt_sig_18); 
  tree_sig_18->SetBranchAddress("mu1_eta",&mu1_eta_sig_18); 
  tree_sig_18->SetBranchAddress("mu1_phi",&mu1_phi_sig_18);

  tree_sig_18->SetBranchAddress("mu2_pt",&mu2_pt_sig_18); 
  tree_sig_18->SetBranchAddress("mu2_eta",&mu2_eta_sig_18); 
  tree_sig_18->SetBranchAddress("mu2_phi",&mu2_phi_sig_18);

  tree_sig_18->SetBranchAddress("jpsi_pt",&jpsi_pt_sig_18); 
  tree_sig_18->SetBranchAddress("jpsi_eta",&jpsi_eta_sig_18); 
  tree_sig_18->SetBranchAddress("jpsi_phi",&jpsi_phi_sig_18);
  tree_sig_18->SetBranchAddress("jpsi_mass",&jpsi_mass_sig_18);

  tree_sig_18->SetBranchAddress("trigDimuon0",&Trig_dimuon_sig_18);
  tree_sig_18->SetBranchAddress("trigJpsiTk",&Trig_JpsiTk_sig_18);

  tree_sig_18->SetBranchAddress("munu_pt",&munu_pt_sig_18); 
  tree_sig_18->SetBranchAddress("munu_eta",&munu_eta_sig_18); 
  tree_sig_18->SetBranchAddress("munu_phi",&munu_phi_sig_18);
  ...
  TH2D* hmu_mu_pt_eta_scatter_sig_17 = new TH2D("hmu_mu_pt_eta_scatter_sig_17","Scatter plot of transverse momentum of unpaired muon",100,-5,5,100,0,20);
  TH2D* hmu_mu_pt_eta_scatter_sig_18 = new TH2D("hmu_mu_pt_eta_scatter_sig_18","Scatter plot of transverse momentum of unpaired muon",100,-5,5,100,0,20);
  TH2D* hmu_mu_pt_eta_scatter_sig = new TH2D("hmu_mu_pt_eta_scatter_sig","Scatter plot of transverse momentum of unpaired muon",100,-5,5,100,0,20);
  TH2D* hmu_jpsi_pt_eta_scatter_sig_17 = new TH2D("hmu_jpsi_pt_eta_scatter_sig_17","Scatter plot of transverse momentum of J/#Psi with eta",100,-5,5,100,0,40);
  TH2D* hmu_jpsi_pt_eta_scatter_sig_18 = new TH2D("hmu_jpsi_pt_eta_scatter_sig_18","Scatter plot of transverse momentum of J/#Psi with eta",100,-5,5,100,0,40);
  TH2D* hmu_jpsi_pt_eta_scatter_sig = new TH2D("hmu_jpsi_pt_eta_scatter_sig","Scatter plot of transverse momentum of J/#Psi with eta",100,-5,5,100,0,40);
  ...
  **/
  ...
  hmu_jpsi_pt_sig_17->SetLineColor(kBlue);
  hmu_jpsi_pt_sig_17->DrawNormalized("same");
  ...
  hmu_bc_pt_sig_17->SetLineColor(kBlue);
  hmu_bc_pt_sig_17->DrawNormalized("same");
  ...
  hmu_bc_pt_corr_sig_17->SetLineColor(kBlue);
  hmu_bc_pt_corr_sig_17->DrawNormalized("same");
  ...
  hmu_bc_pt_ratio_sig_17->SetLineColor(kBlue);
  hmu_bc_pt_ratio_sig_17->DrawNormalized("same");
  ...
  hmu_bc_pt_scatter_sig_17->SetMarkerColor(kBlue);
  hmu_bc_pt_scatter_sig_17->DrawNormalized("same");
  ...
  //Scatter plot of Transverse momentum of Bc with eta for 2017
  hmu_bc_pt_eta_scatter_sig_17->SetMarkerColor(kBlue);
  hmu_bc_pt_eta_scatter_sig_17->GetXaxis()->SetTitle("#eta^{B_{c}}");
  hmu_bc_pt_eta_scatter_sig_17->GetYaxis()->SetTitle("P_{T}^{B_{c}} (GeV)");
  hmu_bc_pt_eta_scatter_sig_17->Draw();
  c1->SaveAs("scatter_Pt_eta_Bc_2017.png");
  ...
  //Scatter plot of Transverse momentum of mu with eta for 2017
  hmu_mu_pt_eta_scatter_sig_17->SetMarkerColor(kBlue);
  hmu_mu_pt_eta_scatter_sig_17->GetXaxis()->SetTitle("#eta^{#mu}");
  hmu_mu_pt_eta_scatter_sig_17->GetYaxis()->SetTitle("P_{T}^{#mu} (GeV)");
  hmu_mu_pt_eta_scatter_sig_17->Draw();
  c1->SaveAs("scatter_Pt_eta_mu_2017.png");
  ...
  //Scatter plot of Transverse momentum of jpsi with eta for 2017
  hmu_jpsi_pt_eta_scatter_sig_17->SetMarkerColor(kBlue);
  hmu_jpsi_pt_eta_scatter_sig_17->GetXaxis()->SetTitle("#eta^{J/#Psi}");
  hmu_jpsi_pt_eta_scatter_sig_17->GetYaxis()->SetTitle("P_{T}^{J/#Psi} (GeV)");
  hmu_jpsi_pt_eta_scatter_sig_17->Draw();
  c1->SaveAs("scatter_Pt_eta_jpsi_2017.png");
  ...
  hprof_sig_18->Draw();
  hprof_sig_17->SetLineColor(kBlue);
  hprof_sig_17->Draw("same");
  ...
  hmu_bc_pt_sig_18->SetLineColor(kRed);
  hmu_bc_pt_sig_18->GetXaxis()->SetTitle("Corrected P_{T}^{Bc} (GeV)");
  hmu_bc_pt_sig_18->GetYaxis()->SetTitle("a.u.");
  hmu_bc_pt_sig_18->DrawNormalized();
  hmu_bc_pt_sig->SetLineColor(kBlue);
  hmu_bc_pt_sig->DrawNormalized("same");
  hmu_bc_pt_corr_sig_18->SetLineColor(kGreen);
  hmu_bc_pt_corr_sig_18->DrawNormalized("same");
  hmu_bc_pt_corr_sig->SetLineColor(kYellow);
  hmu_bc_pt_corr_sig->DrawNormalized("same");
  legend->AddEntry(hmu_bc_pt_corr_sig_18, "#mu channel_recco", "l");
  legend->AddEntry(hmu_bc_pt_corr_sig, "#tau channel_recco", "l");
  legend->Draw();
  ...
  hmu_m2_miss_sig_18->SetLineColor(kRed);
  hmu_m2_miss_sig_18->GetXaxis()->SetTitle("Corrected m_{miss}^{2} (GeV^{2})");
  hmu_m2_miss_sig_18->GetYaxis()->SetTitle("a.u.");
  hmu_m2_miss_sig_18->DrawSig_18alized();
  hmu_m2_miss_sig->SetLineColor(kBlue);
  hmu_m2_miss_sig->DrawNormalized("same");
  hmu_m2_miss_corr_sig_18->SetLineColor(kGreen);
  hmu_m2_miss_corr_sig_18->DrawNormalized("same");
  hmu_m2_miss_corr_sig->SetLineColor(kYellow);
  hmu_m2_miss_corr_sig->DrawNormalized("same");
  legend->Draw();
  ...
  hmu_Q2_sig_18->SetLineColor(kRed);
  hmu_Q2_sig_18->GetXaxis()->SetTitle("Corrected Q^{2} (GeV^{2})");
  hmu_Q2_sig_18->GetYaxis()->SetTitle("a.u.");
  hmu_Q2_sig_18->DrawNormalized();
  hmu_Q2_sig->SetLineColor(kBlue);
  hmu_Q2_sig->DrawNormalized("same");
  hmu_Q2_corr_sig_18->SetLineColor(kGreen);
  hmu_Q2_corr_sig_18->DrawNormalized("same");
  hmu_Q2_corr_sig->SetLineColor(kYellow);
  hmu_Q2_corr_sig->DrawNormalized("same");
  legend->Draw();
  ...
  hmu_Pt_miss_sig_18->SetLineColor(kRed);
  hmu_Pt_miss_sig_18->GetXaxis()->SetTitle("Corrected P_{T}^{miss} (GeV)");
  hmu_Pt_miss_sig_18->GetYaxis()->SetTitle("a.u.");
  hmu_Pt_miss_sig_18->DrawNormalized();
  hmu_Pt_miss_sig->SetLineColor(kBlue);
  hmu_Pt_miss_sig->DrawNormalized("same");
  hmu_Pt_miss_corr_sig_18->SetLineColor(kGreen);
  hmu_Pt_miss_corr_sig_18->DrawNormalized("same");
  hmu_Pt_miss_corr_sig->SetLineColor(kYellow);
  hmu_Pt_miss_corr_sig->DrawNormalized("same");
  legend->Draw();
  ...
  hmu_bc_pt_sig->SetLineColor(kBlue);
  hmu_bc_pt_sig->DrawNormalized("same");
  hmu_recco_bc_pt_sig_18->SetLineColor(kGreen);
  hmu_recco_bc_pt_sig_18->DrawNormalized("same");
  hmu_recco_bc_pt_sig->SetLineColor(kYellow);
  hmu_recco_bc_pt_sig->DrawNormalized("same");
  legend->Draw();
